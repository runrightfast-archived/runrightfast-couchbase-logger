...
(function() {
	 ...
	 * event name is 'CONN_ERR' and the event data the Error
	 * 
	...
	/**
	 * emits an 'LOG_EVENT_ERR' if logging the event failed, with an object as
	 * the event data containing the Error and event:
	 * 
	 * <code>{ error : error, event : event }</code>
	 * 
